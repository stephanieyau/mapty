...
class Workout {
  ...
  _setDescription() {
    ...
    this.description = `${this.type[0].toUpperCase()}${this.type.slice(1)} on ${
      months[this.date.getMonth()] // 'type' received from sub-classes
    } ${this.date.getDate()}`;
  }
...
// Create sub-classes - Running and Cycling
...
class App {
  ...
  constructor() {
    // Load page event triggers constructor which then triggers _getPosition. this points to const app
    this._getPosition();
  ...
  _renderWorkout(exercise) {
    ...
    if (exercise.type === 'cycling')
      html += `
        ...
        <div class="workout__details">
          <span class="workout__icon">⛰</span>
          <span class="workout__value">${exercise.elevationGain}</span>
...
const app = new App();
console.log(app); // Check this out - App has all those private fields and methods
